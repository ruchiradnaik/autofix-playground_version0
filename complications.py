...
class DataProcessor:
    ...
    def process(self) -> Dict[str, float]:
        ...
        for record in self.data:
            ...
            t = threading.Thread(
                target=lambda r=record: normalized_data.append(self._normalize(r))  # Pass record to avoid late binding
            )
        ...
        with self.lock:  # Ensure thread-safe access to shared resource
